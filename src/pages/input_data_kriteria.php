        ...
        <div class="w-auto h-auto flex flex-col gap-10 items-center">
            ...
            <div class="w-auto h-auto flex flex-col">
                ...
                <div class="w-full h-20 flex justify-end py-5 gap-5">
                    <button class="w-auto h-full bg-primary-border rounded-[20px] flex justify-center items-center">
                        <img src="../../src/images/home.svg" alt="">
                    </button>
                    <button class="w-[100px] h-full bg-primary-surface rounded-[20px] flex justify-center items-center">
                        <p class="font-poppins text-base font-normal">Kembali</p>
                    </button>
                    <button class="w-[100px] h-full bg-primary-main rounded-[20px] flex justify-center items-center">
