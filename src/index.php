...
<body class="">
    <div class="w-svw h-svh flex justify-center items-center relative">
        ...
        <div class="w-[800px] flex flex-col gap-10 items-center">
            ...
            <a class="w-[154px] h-[40px] flex justify-center items-center hover:cursor-pointer bg-primary-main rounded-full font-poppins font-semibold text-l text-white transition-all ease-in-out hover:w-[184px]" href="./pages/sequence.php">Home</a>
        </div>
    </div>
</body>
</html>